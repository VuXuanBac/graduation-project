...
\addbibresource{bibliography.bib} % chèn file chứa danh mục tài liệu tham khảo vào 
...
\graphicspath{{Figures/}} % Thư mục chứa các hình ảnh
...
\newpage
\pagenumbering{gobble} % Xóa page numbering ở cuối trang
\subfile{Chapters/0Thanks}

\newpage
\pagenumbering{gobble}
\subfile{Chapters/0Commitment}

% \pagestyle{empty} % Header và footer rỗng
\newpage
\pagenumbering{gobble} % Xóa page numbering ở cuối trang
\subfile{Chapters/0Abstract}
...
\subfile{Chapters/1Introduction} % Phần mở đầu

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{NỀN TẢNG LÝ THUYẾT}
\subfile{Chapters/2Theory}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{MÔ HÌNH HỆ THỐNG}
\subfile{Chapters/3Model}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{PHƯƠNG PHÁP ĐỀ XUẤT}
\subfile{Chapters/4Propose}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{ĐÁNH GIÁ THỰC NGHIỆM}
\subfile{Chapters/5Experiment}

\newpage
\chapter{KẾT LUẬN}
\subfile{Chapters/6Conclusion}
...
\chapter{Phân tích kênh truyền}
\subfile{Chapters/AppendixA}

\newpage
\chapter{Phân tích mức độ không rõ ràng của kẻ nghe lén}
\subfile{Chapters/AppendixB}

\newpage
\chapter{Phân tích xác suất truyền tin}
